...
export default function LandingPage() {
    ...
    return (
        <div className="bg-slate-50 text-slate-800 min-h-screen font-sans overflow-x-hidden selection:bg-cyan-500/30 selection:text-cyan-200">
            {/* Background Orbs */}
            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <motion.div
                    ...
                    className="absolute top-[-100px] left-[-100px] w-96 h-96 bg-blue-600/20 blur-[120px] rounded-full mix-blend-multiply"
                />
                <motion.div
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 2, delay: 0.5, ease: "easeOut" }}
                    className="absolute bottom-[-100px] right-[-100px] w-96 h-96 bg-indigo-600/20 blur-[120px] rounded-full mix-blend-multiply"
                />
            </div>
            ...
            <motion.header
                ...
                className="fixed top-0 left-0 w-full z-50 bg-[#0f172a]/95 backdrop-blur-xl border-b border-white/5 shadow-md"
            >
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <a href="/" className="flex items-center gap-4 group">
                        <div className="w-11 h-11 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg transition-transform group-hover:scale-105">
                            <span className="text-white font-black tracking-wider text-sm">DI</span>
                        </div>
                        <div>
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        {["Features", "How it works", "Pricing"].map((item, i) => (
                            ...
                            >
                                {item}
                                <span className="absolute -bottom-2 left-0 w-0 h-0.5 bg-blue-500 group-hover:w-full transition-all duration-300 rounded-full"></span>
                            </a>
                        ))}
                    </div>
                </div>
            ...
            <section className="relative min-h-[100svh] pt-32 pb-20 px-6 flex items-center overflow-hidden">
                ...
                >
                    ...
                    >
                        ...
                        <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur-md border border-cyan-500/30 rounded-full shadow-[0_0_15px_rgba(6,182,212,0.15)]">
                        ...
                        <motion.h1 variants={fadeUp} className="text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight text-slate-900 drop-shadow-sm">
                            Never Lose
                        ...
                        <motion.p variants={fadeUp} className="text-lg lg:text-xl text-slate-600 max-w-lg leading-relaxed font-light">
                        ...
                        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-5">
                            ...
                            <button className="px-8 py-4 bg-white border border-slate-200 hover:bg-gray-50 text-slate-900 rounded-xl font-semibold shadow-sm transition-all duration-300 flex items-center justify-center focus:ring-2 focus:ring-blue-500/20">
                                View Demo
                            </button>
                        </motion.div>
                    ...
                    >
                        ...
                        >
                            {/* Main Display Mockup */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[350px] bg-white border border-slate-200/50 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
                                <div className="w-full h-8 bg-gray-100 border-b border-slate-200 flex items-center px-4 gap-2">
                                ...
                                <div className="p-6 h-[calc(100%-2rem)] flex flex-col gap-4">
                                    ...
                                    <div className="flex-1 w-full bg-gray-100/50 rounded-lg border border-slate-200/50 p-5">
                            ...
                            <motion.div
                                ...
                                className="absolute top-10 left-0 w-64 bg-white/80 backdrop-blur-xl border border-slate-200/10 rounded-2xl p-5 shadow-[0_10px_30px_rgba(0,0,0,0.3)]"
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="p-2 bg-emerald-500/20 rounded-lg">
                                        <CheckCircle className="w-5 h-5 text-emerald-400" />
                                    </div>
                                    <span className="text-sm font-semibold text-slate-700">Decisions Tracked</span>
                                </div>
                                <h2 className="text-3xl font-black text-slate-900">8,472</h2>
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-10 right-0 w-72 bg-white/80 backdrop-blur-xl border border-slate-200/10 rounded-2xl p-5 shadow-[0_10px_30px_rgba(0,0,0,0.3)]"
                            >
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="p-2 bg-purple-500/20 rounded-lg">
                                        <Brain className="w-5 h-5 text-purple-400" />
                                    </div>
                                    <span className="text-sm font-semibold text-slate-700">AI Insights Synthesized</span>
                                </div>
            ...
            {/* Video Section */}
            <section className="py-24 px-6 relative z-10 bg-white/30">
                <motion.div
                    initial="hidden"
                    whileInView="visible"
                ...
                >
                    <motion.h2 variants={fadeUp} className="text-3xl lg:text-5xl font-black text-slate-900 mb-4">
                        See It In <span className="text-transparent bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text">Action</span>
                    </motion.h2>
                    <motion.p variants={fadeUp} className="text-slate-600 mb-12 max-w-2xl mx-auto">Experience how Decision Intel transforms your chaotic inbox into a structured command center.</motion.p>

                    <div className="relative z-20 w-full max-w-5xl mx-auto flex justify-center">
                        <motion.div variants={fadeUp} className="relative rounded-3xl p-1 bg-gradient-to-b from-blue-100 to-white transform transition hover:scale-[1.01] duration-500 z-20 w-fit shadow-xl border border-blue-50">
                            ...
                            <motion.img
                                ...
                                className="absolute -left-20 sm:-left-40 top-16 w-48 sm:w-80 rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.7)] border border-slate-200/10 hidden lg:block opacity-90 hover:opacity-100 transition-opacity z-[-1]"
                            />
                            ...
                            <motion.img
                                ...
                                className="absolute -right-20 sm:-right-40 bottom-16 w-48 sm:w-80 rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.7)] border border-slate-200/10 hidden lg:block opacity-90 hover:opacity-100 transition-opacity z-30"
                            />

                            <video
                                className="relative z-10 w-full max-w-3xl rounded-[20px] shadow-2xl bg-[#f1f5f9] border border-slate-200/5"
                                controls
                                autoPlay
                                muted
                                loop
            ...
            <section className="py-24 relative z-10 bg-white/30 border-t border-slate-200/5 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <motion.h2 variants={fadeUp} className="text-4xl lg:text-5xl font-black text-slate-900 drop-shadow-sm mb-4">
                ...
                >
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="w-full md:w-[75%] relative pt-24 md:pt-28 pb-4 pointer-events-none">
                                        ...
                                        >
                                            <h3 className="text-xl sm:text-2xl md:text-4xl font-extrabold text-slate-900 shadow-none drop-shadow-lg tracking-tight mb-2 md:mb-3">
                                                {page.title}
                                            </h3>
                                            <span className="text-[10px] sm:text-xs md:text-lg text-blue-700 font-semibold px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-blue-50 border border-blue-100 backdrop-blur-md inline-block max-w-[95%] sm:max-w-[80%] md:max-w-none shadow-sm">
                                                {page.desc}
                                            </span>
                                        </motion.div>
                                        ...
                                        <div className="relative pointer-events-none w-full">
                                            ...
                                            <div className="relative rounded-xl md:rounded-2xl overflow-hidden border border-slate-200 shadow-2xl bg-white">
                                                <div className="h-6 md:h-8 bg-gray-100 border-b border-slate-200 flex items-center px-3 md:px-4 gap-1.5 md:gap-2">
                    ...
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-6 z-40">
                        <button
                            ...
                            className="p-3 rounded-full bg-white/90 hover:bg-white hover:scale-110 active:scale-95 backdrop-blur-md border border-slate-200 text-slate-900 transition-all shadow-lg"
                        >
                        ...
                        <div className="flex gap-3">
                            {[0, 1, 2].map((dot) => (
                                <button
                                    ...
                                    className={`h-2 rounded-full transition-all duration-300 ${activeSlide === dot ? 'w-8 bg-blue-600 shadow-md' : 'w-2 bg-slate-300 hover:bg-slate-400'}`}
                                />
                            ))}
                        </div>
                        ...
                        {faqs.map((faq, i) => {
                            ...
                            return (
                                <motion.div
                                    key={i}
                                    variants={fadeUp}
                                    className={`border rounded-2xl transition-all duration-300 overflow-hidden ${isOpen ? "bg-white border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.15)]" : "bg-white/50 border-slate-200"}`}
                                >
                                    <button
                                    ...
                                    >
                                        ...
                                        <div className={`p-2 rounded-full transition-colors ${isOpen ? "bg-blue-500/10 text-blue-600" : "bg-gray-100 text-slate-600 group-hover:bg-gray-200"}`}>
            ...
            <section className="relative py-24 md:py-40 px-6 z-10 text-center">
                ...
                >
                    <motion.div
                        variants={fadeUp}
                        className="relative rounded-[2rem] bg-[#0f172a] shadow-2xl p-3 md:p-16 overflow-hidden group border border-[#1e293b]"
                    >
                        {/* Dynamic Background */}
                        <div className="absolute inset-0 opacity-40 mix-blend-screen pointer-events-none">
                            <div className="absolute -top-32 -left-32 w-96 h-96 bg-blue-600/30 rounded-full blur-[80px] group-hover:scale-110 transition-transform duration-1000"></div>
                            <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-cyan-600/30 rounded-full blur-[80px] group-hover:scale-110 transition-transform duration-1000 delay-100"></div>
                        </div>
                        ...
                        <div className="relative z-10 flex flex-col items-center text-white">
                            <motion.div
                                ...
                                className="block mb-8 p-4 bg-white/10 border border-white/20 rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.5)]"
                            >
                            ...
                            <h2 className="text-4xl lg:text-5xl font-black mb-6 text-white tracking-tight">
                                ...
                                <span className="text-transparent bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text">Email Game?</span>
                            </h2>
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={handleGetStarted}
                                className="group relative px-6 py-3 bg-blue-600 hover:bg-blue-500 rounded-2xl font-bold flex items-center gap-3 overflow-hidden shadow-lg transition-all"
                            >
            ...
            <motion.footer
                ...
                className="py-12 px-6 bg-[#0f172a] text-white relative z-10 border-t border-[#1e293b]"
            >
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-4 group">
                        <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center font-bold text-white transition-transform group-hover:scale-105">
                            DI
                        </div>
                        <span className="font-bold tracking-wide">Decision Intel</span>
                    </div>

                    <div className="flex gap-8 text-sm font-medium text-gray-400">
                        {["Privacy", "Terms", "Contact", "Twitter"].map((item, i) => (
                            <a key={i} href="#" className="hover:text-blue-400 transition-colors" onClick={(e) => e.preventDefault()}>
                                {item}
                            </a>
                        ))}
                    </div>
